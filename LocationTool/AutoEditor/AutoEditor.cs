    ...
    namespace AutoEditor
    {
        public static class AutoEdCntrlBuilder
        {
            ...
            public static void CreateControl(EditorFieldAttr attr, Type t, ref System.Object obj)
            {
                ...
                {
                    // ** Extended for Location tool ** //
                    info = t.GetField(attr.Name);
                    if (info != null)
                    {
                        LocationTool.LocationCategory ctrl = (LocationTool.LocationCategory)info.GetValue(obj);
                        ctrl = (LocationTool.LocationCategory)EditorGUILayout.EnumPopup("locationType", ctrl);
        ...
        public enum ControlType
        {
            ...
            LocationCategory, // ** Extended for LocationTool ** //
            PaintMode, // ** Extended for McWorldEditor ** //
            LayersItemsType, // ** Extended for McWorldEditor ** //
        }
    }
}
